...
describe('[Challenge] Climber', function () {
    ...
    it('Exploit', async function () {
        ...
        const maliciousUUPSFactory = await ethers.getContractFactory('MaliciousUUPS',
            attacker);
        maliciousUUPS = await maliciousUUPSFactory.deploy();
        await maliciousUUPS.connect(attacker).attack(
            this.token.address,
